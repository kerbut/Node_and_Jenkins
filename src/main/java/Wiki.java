...
//
//        options.addArguments("--font-cache-shared-handle");


        FirefoxOptions opt = new FirefoxOptions();
        opt.addPreference("media.autoplay.default", 1);

        driver = new FirefoxDriver(opt);

        driver.get("https://promo.maximarkets.org/demo-real_autoplay/");
        System.out.println("!!!!!!!!!!!!!!!!!!!!");
...
//
//        driver.get("chrome://flags/#enable-font-cache-scaling");
//
//        Select select = new Select (driver.findElement(By.xpath("//h3[text()='FontCache scaling']/../following::div[1]//select[@class='experiment-select']")));
//        System.out.println(select.getFirstSelectedOption().getText());
//
//        select.selectByVisibleText("Enabled");
//        System.out.println(select.getFirstSelectedOption().getText());
//        WebDriverWait wait = (new WebDriverWait(driver,5));
//        WebElement butt = driver.findElement(By.xpath("//button[@class= 'experiment-restart-button']"));
//        wait.until(ExpectedConditions.elementToBeClickable(butt));
//        butt.click();
//
//        Thread.sleep(5000);
...
//
//        driver.get("https://investforum.sandybox.tk/forum/ucp.php?mode=login");
//
//        driver.findElement(By.xpath("//input[@name='username']")).sendKeys("Admin_WP");
//        driver.findElement(By.xpath("//input[@name='password']")).sendKeys("SWg27sd");
//        driver.findElement(By.xpath("//input[@name='login']")).click();
//        driver.findElement(By.xpath("//a[@title='Средне и долгосрочные прогнозы по  AUDCHF']")).click();
//        driver.findElement(By.xpath("//div[@class='topic-actions viewtopic_body-actions']//a[@class='if-button_a']")).click();
//
//        int count = 0;
//        do {
//            count+=1;
//            driver.findElement(By.xpath("//textarea[@id='message']")).sendKeys(Integer.toString(count));
//            //driver.findElement(By.xpath("//span[text()='Добавить вложения']/..")).click();
//           // driver.findElement(By.xpath("//input[@type='file']")).sendKeys("C:\\Users\\kerbu\\Downloads\\mail.jpg");
//           // driver.findElement(By.xpath("//textarea[@id='filecomment']")).sendKeys(Integer.toString(count));
//           // driver.findElement(By.xpath("//input[@name='add_file']")).click();
//            //Thread.sleep(5000);
...
//        while (false);
      ...
      /*  try {
        ...
        wait.until(ExpectedConditions.attributeContains(By.xpath("//h1")));
